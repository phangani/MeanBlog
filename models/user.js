...
const usernamelValidators = [
    { validator: usernameLengthChecker, message: 'Username must be at least 3 characters but no more than 15'},
    { validator: validUsername, message: 'Username must not have any special characters'}
];
...
const userSchema = new Schema({
    ...
    username: { type:String, required:true, unique:true, lowercase:true, validate: usernamelValidators },
    password: { type:String, required:true, validate: passwordlValidators }
});
